...
<h3>Customers</h3>
<button class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target="#addCustomerModal">Add Customer</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="customers_add.php">
...
<script>$(document).ready(function(){$('#customersTable').DataTable();});</script>
