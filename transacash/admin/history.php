...
error_log("Rates: " . json_encode($rates));
          ...
          <?php else: ?>
            <?php $i = 1; while ($row = $result->fetch_assoc()): ?>
              <?php
                ...
                error_log("Transaction {$row['id']}: rate_key=$rate_key, exchange_rate=$exchange_rate, from_amount={$row['from_amount']}, converted=$converted, fee_percent=$fee_percent, fee=$fee, net_amount=$net_amount, stored_customer_receives={$row['customer_receives']}");
              ?>
              <tr>
                <td><?= $i++ ?></td>
            ...
            <body>
              <div class="print-section">
                ...
                <table>
                  ...
                  <tr>
                    <th>Fee</th>
                    <td>${transaction.fee} ${transaction.to_currency}</td>
                  </tr>
                  <tr>
                    <th>Net Received</th>
