...
// Fetch expenses
$expenses = $pdo->query("SELECT * FROM expenses ORDER BY created_at DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!doctype html>
<html lang="en">
<head>
...
<h3>Expenses</h3>
<button class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target="#addExpenseModal">Add Expense</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="expenses_add.php">
          <div class="mb-3"><label class="form-label">Title</label><input class="form-control" name="title"></div>
          <div class="mb-3"><label class="form-label">Amount</label><input type="number" class="form-control" name="amount" step="0.01"></div>
...
<script>$(document).ready(function(){$('#expensesTable').DataTable();});</script>
